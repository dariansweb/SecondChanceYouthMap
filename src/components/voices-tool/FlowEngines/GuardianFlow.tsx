// src/components/voices-tool/FlowEngines/GuardianFlow.tsx

"use client";

import { useEffect, useState } from "react";
import ConsentForm from "@/components/voices-tool/Forms/ConsentForm";
import FamilyMeetingForm from "@/components/voices-tool/Forms/FamilyMeetingForm";
import AcknowledgmentForm from "@/components/voices-tool/Forms/AcknowledgmentForm";
...
export default function GuardianFlow() {
  ...
  useEffect(() => {
    const loadFlow = async () => {
      const res = await import("@/data/voices-tool/guardian-flow.json");
