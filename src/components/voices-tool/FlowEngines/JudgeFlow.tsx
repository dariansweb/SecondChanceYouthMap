// src/components/voices-tool/FlowEngines/JudgeFlow.tsx

"use client";

import { useEffect, useState } from "react";
import CaseSummaryReviewForm from "@/components/voices-tool/Forms/CaseSummaryReviewForm";
import DecisionForm from "@/components/voices-tool/Forms/DecisionForm";
import DispositionOrderForm from "@/components/voices-tool/Forms/DispositionOrderForm";
...
export default function JudgeFlow() {
  ...
  const renderForm = () => {
    switch (current?.id) {
      case "case-review":
        return <CaseSummaryReviewForm />;
      case "decision":
        return <DecisionForm />;
      case "disposition-order":
        return <DispositionOrderForm />;
      default:
        return null;
    }
  };
