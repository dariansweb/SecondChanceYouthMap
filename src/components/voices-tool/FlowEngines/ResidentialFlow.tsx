// src/components/voices-tool/FlowEngines/ResidentialFlow.tsx

"use client";

import { useEffect, useState } from "react";
import ResidentialIntakeForm from "@/components/voices-tool/Forms/ResidentialIntakeForm";
import ProgressLogForm from "@/components/voices-tool/Forms/ProgressLogForm";
import TransitionPrepForm from "@/components/voices-tool/Forms/TransitionPrepForm";
...
export default function ResidentialFlow() {
  ...
  const renderForm = () => {
    switch (current?.id) {
      case "intake":
        return <ResidentialIntakeForm />;
      case "progress-log":
        return <ProgressLogForm />;
      case "transition-prep":
        return <TransitionPrepForm />;
      default:
        return null;
    }
  };
