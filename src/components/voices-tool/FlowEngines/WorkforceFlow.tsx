// src/components/voices-tool/FlowEngines/WorkforceFlow.tsx

"use client";

import { useEffect, useState } from "react";
import WorkforceReadinessForm from "@/components/voices-tool/Forms/WorkforceReadinessForm";
import CareerReferralForm from "@/components/voices-tool/Forms/CareerReferralForm";
import JobSupportLogForm from "@/components/voices-tool/Forms/JobSupportLogForm";
  ...
  const renderForm = () => {
    switch (current?.id) {
      case "workforce-readiness":
        return <WorkforceReadinessForm />;
      case "career-referral":
        return <CareerReferralForm />;
      case "job-support-log":
        return <JobSupportLogForm />;
      default:
        return null;
    }
  };
